...
This is document version 2, dated 2026-03-04.
...
There are 3 (three) deadlines for this assignment (the dates are given
on the website) which are chronologically:

1. submit the **formative version** of your assignment
2. attend the **feedback tutorial**;  
   **Part&nbsp;1 ends here, Part&nbsp;2 begins**
3. submit the **summative version** of your assignment.

If you miss one or more of the first two deadlines, then you are
...
exporting. This can be done by having IntelliJ open on your system and visiting [https://plugins.jetbrains.com/plugin/26315-project-to-zip](https://plugins.jetbrains.com/plugin/26315-project-to-zip "Link to the IntelliJ project-to-zip extension"), where the installation button will open an installation window in IntelliJ. Note that your browser may need to ask you for permission to redirect the link to IntelliJ, and that IntelliJ *must* currently be running.
...
| `instructionsWorksheet.md`        | tells you what is required to complete the `worksheet.md` file        |
...
a design to solve the challenge, evaluating how good it is, 
creating an (accessible) worksheet describing your design to the targeted 
audience, and coding that design. Along the way, you will produce artefacts that 
will be submitted for feedback. 

## The challenges ##

For this assignment, you will have to choose one of the challenges in  the `challengesList.md` file in this folder.
...
3. Design your worksheet following the more detailed instructions
...
|-----------------------|-------------------------------------------------------------------------|
                                       |
| `writing.md`          | your reflections on the process                                         |
...
2. Once you have a basic understanding of what you must produce (a
   ...
   `challengesList.md` file in this folder. For each challenge think about:
...
5.  Now consider in more detail how you might design a solution for your chosen challenge. Think about the
    coding mechanisms you know and how these might be applied.
...
7.  Once you have chosen your challenge, think about the design of
...
8. Check that by this stage you have written down:
    ...
    2. a definition of who your beginner audience is including what
       ...
       it elegantly;
    3. your design.
9. Create your worksheet. There are many ways you could do this. **If
...
10. Code your design in `src/Design.java`.
11. **First deadline:** submit your worksheet as an `IntelliJ`
    project zip for feedback. **This is the end of Part&nbsp;1.**
12. **Second deadline:** attend the feedback tutorial.
...
4.  define your target beginner audience (you will probably refine
    this later);
6.  break the challenge down for your beginner audience;
7.  draw one or more diagrams to help visualize the challenge or
    solution or both (all diagrams go in the same file);
8.  seriously attempt to make your diagram(s) accessible;
9. acknowledge your sources of help and information in the
    `acknowledgements.md` file;
10. make a proper effort at Part&nbsp;1.
...
1. require "a lot" of code to implement - a long solution to a 
   CodeGolf challenge suggests an unsuitable design;
2. be super short, for example code-golfed - some of the golfed algorithms
